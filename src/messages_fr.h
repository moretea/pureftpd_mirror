...
#define MSG_BANDWIDTH_RESTRICTED "La bande-passante est soumise a des quotas"
...
#define MSG_NO_FXP "Je n'ouvrirais pas de connexion vers %s (seulement vers %s)"
...
#define MSG_NO_SUPERSERVER "Veuillez lancer PureFTPd depuis un super-serveur (comme tcpserver)"
...
#define MSG_WELCOME_TIME "L'heure locale est %02d:%02d et la charge courante est de %3.2f. Port: %u."
#define MSG_ANONYMOUS_FTP_ONLY "Seules les connexions anonymes sont autorisees"
...
#define MSG_INFO_CPU_TIME "Deloggue - Temps CPU utilise: %ld.%03ld secondes."
