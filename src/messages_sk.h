...
#define MSG_WELCOME_TIME "Lokalny cas je teraz %02d:%02d a systemova zataz je %3.2f. Serverovy port: %u."
...
#define MSG_INFO_CPU_TIME "Logout - pouzity procesorovy cas: %ld.%03ld sekund."
