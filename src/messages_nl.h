...
#define MSG_WELCOME_TIME "Locale tijd is nu %02d:%02d en de belasting is %3.2f. Server poort: %u."
...
#define MSG_INFO_CPU_TIME "Logout - Gebruikte CPU tijd: %ld.%03ld seconden."
