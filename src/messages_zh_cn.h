...
#define MSG_CLIENT_CLOSED_CNX "用户端关闭连线"
#define MSG_CLIENT_READ_ERR "从用户端读取发生错误"
#define MSG_CANT_OPEN_CNX "无法开启连线"
...
#define MSG_CANT_DO_TWICE "在目前连线期间不能这样做"
...
#define MSG_FXP_SUPPORT "这个伺服器支援FXP传输"
...
#define MSG_CANT_PASV "您不能在IPv6连线使用PASV。请改用EPSV。"
#define MSG_CANT_PASSIVE "无法开启被动式连线"
...
#define MSG_NO_EPSV "请使用符合IPv6并支援EPSV的用户端"
#define MSG_BAD_PORT "抱歉，无法连线到 ports < 1024"
#define MSG_NO_FXP "我不能开启连线到 %s (仅 %s)"
#define MSG_FXP "FXP传输: 从 %s 到 %s"
#define MSG_NO_DATA_CONN "无资料连线"
#define MSG_ACCEPT_FAILED "连线无法被接受"
#define MSG_ACCEPT_SUCCESS "接受资料连线"
#define MSG_CNX_PORT_FAILED "无法开启资料连线到port %d"
#define MSG_CNX_PORT "连线到port %d"
#define MSG_ANON_CANT_MKD "抱歉，不准匿名使用者建立目录"
#define MSG_ANON_CANT_RMD "抱歉，不准匿名使用者移除目录"
#define MSG_ANON_CANT_RENAME "不准匿名使用者搬移/更名档案"
#define MSG_ANON_CANT_CHANGE_PERMS "匿名使用者不能变更权限"
#define MSG_GLOB_NO_MEMORY "形成 %s 时，记忆体不足"
...
#define MSG_STAT_FAILURE2 "无法检查档案的存在性"
#define MSG_REST_TOO_LARGE_FOR_FILE "针对档案大小 %lld时，重新开始offset %lld 会过大。"
...
#define MSG_DATA_WRITE_FAILED "资料连线写入时发生错误"
#define MSG_DATA_READ_FAILED "资料连线读取时发生错误"
#define MSG_MMAP_FAILED "无法将档案map进记忆体"
...
#define MSG_SPACE_FREE_M "%.1f Mbytes 剩馀硬碟空间"
#define MSG_SPACE_FREE_K "%f Kbytes 剩馀硬碟空间"
...
#define MSG_RENAME_RNFR_SUCCESS "RNFR接受 - 档案存在，准备到目的地"
...
#define MSG_RENAME_SUCCESS "档案更名/移动OK"
...
#define MSG_ILLEGAL_FORCE_PASSIVE "被动式连线时，不合法的强制IP"
...
#define MSG_NEW_CONNECTION "自 %s 的新连线"
#define MSG_WELCOME_TO "欢迎来到"
#define MSG_MAX_USERS "%lu 使用者(最大值)已经登入，抱歉"
#define MSG_NB_USERS "您是第 %d 个使用者，最多可达 %d 个连线"
#define MSG_WELCOME_TIME "现在本地时间是 %02d:%02d 负载是 %3.2f。伺服器埠口: %u。"
...
#define MSG_MAX_USERS_IP "太多连线 (%lu) 来自这个 IP"
#define MSG_ACTIVE_DISABLED "主动模式关闭"
#define MSG_TRANSFER_SUCCESSFUL "档案传送OK"
#define MSG_NO_DISK_SPACE "硬碟爆满 - 请晚点上传"
#define MSG_OUT_OF_MEMORY "记忆体不足"
...
#define MSG_SQL_MISSING_SERVER "SQL组态档中遗失伺服器设定"
