...
#define MSG_CANT_DO_TWICE "在目前連線期間無法做到"
#define MSG_UNABLE_SECURE_ANON "無法設定安全的匿名FTP"
...
#define MSG_CANT_PASSIVE "無法開啟被動連線"
...
#define MSG_NO_EPSV "請使用的符合IPv6並支援EPSV的用戶端"
...
#define MSG_LOAD_TOO_HIGH \
    "當您連線時負載是 %3.2f 。負載如此高時，我們不准匿名使用者下載。\n" \
    "上傳則都是可以的"

#define MSG_OPEN_FAILURE "無法開啟 %s"
#define MSG_OPEN_FAILURE2 "無法開啟那個檔案"
#define MSG_STAT_FAILURE "無法找到檔案大小"
#define MSG_STAT_FAILURE2 "無法檢查檔案存在性"
#define MSG_REST_TOO_LARGE_FOR_FILE "重新開始offset %lld 過大，針對檔案大小 %lld時。"
...
#define MSG_KBYTES_LEFT "剩 %.1f 供下載"
...
#define MSG_SANITY_DIRECTORY_FAILURE "禁止的目錄名稱"
#define MSG_SANITY_FILE_FAILURE "禁止的檔名: %s"
...
#define MSG_CREATE_FAILURE "無法建立標案"
#define MSG_ABRT_ONLY "當上傳時ABRT唯一合法的命令"
...
#define MSG_RENAME_RNFR_SUCCESS "RNFR接受 - 檔案存在，準備到目的"
...
#define MSG_ILLEGAL_FORCE_PASSIVE "不合法的被動連線強制IP"
...
#define MSG_WELCOME_TIME "現在本地時間是 %02d:%02d 負載是 %3.2f。伺服器埠口: %u。"
...
#define MSG_INFO_CPU_TIME "登出 - CPU 時間花費: %ld.%03ld 秒。"
...
#define MSG_MAX_USERS_IP "太多連線 (%lu) 從此 IP"
...
#define MSG_PERUSER_MAX "拸楊諉忳懂赻肮珨妏蚚氪閉徹 %lu 腔蟀盄杅"
#define MSG_IPV6_OK "涴窒翋儂珩辣茩IPv6腔蟀盄"
